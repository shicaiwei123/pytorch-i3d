...
parser.add_argument('--dataset', type=str, default='kinects400')
...
from data import kinects400
from models import i3dpt

start_iter = 0

nwucla_trainset = kinects400.KINECTS400(data_root="/home/data/shicaiwei/kinects400/rawframes_train",
                                        split_path="../data/split_divide/kinect/kinects400_train.txt",
                                        clip_len=args.clip_len,
                                        mode=args.mode,
                                        sample_interal=1)

nwucla_testset = kinects400.KINECTS400("/home/ssd/video_action/kinects400/rawframes_val",
                                       clip_len=args.clip_len,
                                       split_path="../data/split_divide/kinect/kinects400_val.txt",
                                       mode=args.mode,
                                       sample_interal=1)
