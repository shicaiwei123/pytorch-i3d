...
parser.add_argument('--load',
                    default="")  #/home/icml//shicaiwei/pytorch-resnet3d/src/cs/tmp/ntud120/depth/16/ckpt_E_34_I_1.pth
...
parser.add_argument('--dataset', type=str, default='ntud120')
...
from data import ntud120
from models import resnet

nwucla_trainset = ntud120.NTUD120_CS(data_root="/home/data/shicaiwei/NTUD60",
                                   clip_len=args.clip_len,
                                   mode=args.mode,
                                   train=True,
                                   sample_interal=1)

nwucla_testset = ntud120.NTUD120_CS(data_root="/home/data/shicaiwei/NTUD60",
                                  clip_len=args.clip_len,
                                  mode=args.mode,
                                  train=False,
                                  sample_interal=1)
...
net.fc = nn.Linear(in_features=2048, out_features=120, bias=True)
