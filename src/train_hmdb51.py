...
parser.add_argument('--dataset', type=str, default='hmdb51_224_uniform_0.1')
...
def train(iteration=0):
    ...
    cos_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[30,
                                                                          60])
...
net.fc = nn.Linear(in_features=2048, out_features=51, bias=True)
